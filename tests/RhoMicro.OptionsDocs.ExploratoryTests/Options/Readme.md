...
| Type | <details><summary>```MutableJsonSchemaGeneratorOptions```</summary>```RhoMicro.OptionsDocs.Generators.MutableJsonSchemaGeneratorOptions```</details> |
| Disallowed Values | `null` |
...
| Type | <details><summary>```MutableOptionsDocsRunnerOptions```</summary>```RhoMicro.OptionsDocs.Services.MutableOptionsDocsRunnerOptions```</details> |
| Disallowed Values | `null` |
...
| Type | <details><summary>```ExitMode```</summary>```RhoMicro.OptionsDocs.Services.ExitMode```</details> |
...
| Type | <details><summary>```MutableReadmeGeneratorOptions```</summary>```RhoMicro.OptionsDocs.Generators.MutableReadmeGeneratorOptions```</details> |
| Disallowed Values | `null` |
...
| -- | -- |
| Key | `Test` |
| Type | <details><summary>```TestOptions```</summary>```RhoMicro.OptionsDocs.ExploratoryTests.TestOptions```</details> |
| Disallowed Values | `null` |
...
| -- | -- |
| Key | `Test:NestedSet` |
| Type | <details><summary>```HashSet<TestNestedOptions>```</summary>```System.Collections.Generic.HashSet<RhoMicro.OptionsDocs.ExploratoryTests.TestNestedOptions>```</details> |
| Disallowed Values | `null` |
...
| Type | <details><summary>```TestNestedOptions```</summary>```RhoMicro.OptionsDocs.ExploratoryTests.TestNestedOptions```</details> |
| Disallowed Values | `null` |
