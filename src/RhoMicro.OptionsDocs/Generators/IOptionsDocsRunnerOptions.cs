...
/// <summary>
/// Provides options for the <see cref="OptionsDocsGeneratorRunner"/>.
/// </summary>
[Description("Provides options for the options docs runner."), Options]
public partial interface IOptionsDocsRunnerOptions
{
    /// <summary>
    ...
    [Description(
     ...
     DefaultValueExpression("global::RhoMicro.OptionsDocs.Services.ExitMode.Environment")]
