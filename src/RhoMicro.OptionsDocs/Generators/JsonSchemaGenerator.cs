...
public sealed class JsonSchemaGenerator(
    ...
    ILogger<JsonSchemaGenerator> logger) : IOptionsDocsGenerator
{
    ...
    /// <inheritdoc />
    public async ValueTask Run(IOptionsDocsGeneratorOptions optionsDocsGeneratorOptions, CancellationToken cancellationToken = default)
    {
