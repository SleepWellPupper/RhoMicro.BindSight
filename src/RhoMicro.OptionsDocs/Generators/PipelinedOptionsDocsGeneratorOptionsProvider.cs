...
/// </param>
public sealed class PipelinedOptionsDocsGeneratorOptionsProvider(
    ...
    : IOptionsDocsGeneratorOptionsProvider
{
    /// <inheritdoc />
    public async ValueTask<IOptionsDocsGeneratorOptions> GetOptions(CancellationToken cancellationToken = default)
    {
        ...
        var result = new OptionsDocsGeneratorOptions()
        {
