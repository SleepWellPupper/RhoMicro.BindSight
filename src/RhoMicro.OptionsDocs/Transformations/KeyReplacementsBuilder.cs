...
/// </summary>
public sealed class KeyReplacementsBuilder(OptionsDocsBuilder optionsDocs) : IKeyReplacementsProvider
{
    /// <summary>
    ...
    [
        ...
        nameof(MutableOptionsDocsGeneratorOptions),
        nameof(MutableOptionsDocsRunnerOptions),
    ];
    ...
    /// <item><c>MutableOptionsDocsGeneratorOptions</c> -> <c>OptionsDocsGeneratorOptions</c></item>
    /// <item><c>MutableOptionsDocsRunnerOptions</c> -> <c>OptionsDocsRunnerOptions</c></item>
    /// </list>
    /// </remarks>
    /// <returns>
    /// A reference to the builder, for chaining of further method calls.
