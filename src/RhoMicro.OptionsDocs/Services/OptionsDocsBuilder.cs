...
/// </summary>
public sealed class OptionsDocsBuilder
{
    /// <summary>
    ...
    /// </param>
    public OptionsDocsBuilder(IServiceCollection services)
    {
        Services = services;
        Generators = new(this);
    ...
    /// </returns>
    public OptionsDocsBuilder AddHostedService()
    {
        Services.AddHostedService<OptionsDocsBackgroundService>();
    ...
    /// A reference to this builder, for chaining of further method calls.
    /// </returns>
    public OptionsDocsBuilder AddDefaults()
        => AddHostedService()
