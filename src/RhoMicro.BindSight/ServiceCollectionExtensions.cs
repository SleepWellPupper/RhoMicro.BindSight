...
public static partial class ServiceCollectionExtensions
{
    ...
    public static BindSightBuilder AddBindSight(this IServiceCollection services)
    {
        ...
        var result = new BindSightBuilder(services);

        services
            .TryAddBindSightGeneratorOptions(c => c.UseCustomOptions(_ => new BindSightGeneratorOptions()))
            .TryAddBindSightRunnerOptions()
            .AddLogging();
        ...
        services.TryAddSingleton<BindSightGeneratorRunner>();

        services.TryAddSingleton<IHostApplicationLifetime, NullApplicationHostLifetime>();
        services.TryAddSingleton<IBindSightGeneratorOptionsProvider>(sp =>
            new PipelinedBindSightGeneratorOptionsProvider(
                sp.GetRequiredService<IBindSightGeneratorOptions>(),
                services,
    ...
    public static OptionsBuilder<TOptions> AddDocumentedOptions<TOptions>(
        ...
        => services.AddDocumentedOptions<TOptions>(
            configSectionPath: Options.DefaultName,
            configureBinder);
